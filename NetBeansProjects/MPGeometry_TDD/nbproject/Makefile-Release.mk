...
${TESTDIR}/tests/01UnitPoint.o: tests/01UnitPoint.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/01UnitPoint.o tests/01UnitPoint.cpp


${TESTDIR}/tests/02UnitRectangle.o: tests/02UnitRectangle.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/02UnitRectangle.o tests/02UnitRectangle.cpp


${TESTDIR}/tests/10Integration.o: tests/10Integration.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10Integration.o tests/10Integration.cpp
...
${OBJECTDIR}/src/Point2D_nomain.o: ${OBJECTDIR}/src/Point2D.o src/Point2D.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Point2D_nomain.o src/Point2D.cpp;\
	else  \
...
${OBJECTDIR}/src/Rectangle_nomain.o: ${OBJECTDIR}/src/Rectangle.o src/Rectangle.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Rectangle_nomain.o src/Rectangle.cpp;\
	else  \
